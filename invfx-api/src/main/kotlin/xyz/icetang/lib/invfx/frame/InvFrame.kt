...
package xyz.icetang.lib.invfx.frame

import xyz.icetang.lib.invfx.InvDSL
...
interface InvFrame: InvSpace {
    ...
    fun pane(minX: Int, minY: Int, maxX: Int, maxY: Int, init: xyz.icetang.lib.invfx.frame.InvPane.() -> Unit): xyz.icetang.lib.invfx.frame.InvPane
